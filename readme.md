...
3. Sabian Saliasi
    > Rising Junior, studying Math and CS. Presently doing research on Machine Learning methods within Quantitative Finance and working as in a start-up environment as a Machine Learning and Software Engineer at AI Academy, pushing to provide resources in Math, CS, ML, etc, to students from under-represented backgrounds.
